...
public class MazeHelper {
    ...
    Stack<Node> calculatePacmanPath(Maze mz, Node ghostNode , Node pacManNode,  int mazeXLenngth, int mazeYLength){
...
//
        ...
        while(true){
            ...
            if(currentNode.getX()+1<mazeXLenngth && mz.moveDown(currentNode.getX(), currentNode.getY()) ){
                tempNode = new Node(currentNode.getX()+1, currentNode.getY());
                checkCost(currentNode, tempNode, currentNode.getFinalCost());
            }
